...
fun main() {
    ...
    while (n != "exit") {
        ...
        if (n != "exit") {
            when (n) {
                "0" -> println(animals[n.toInt()])
                "1" -> println(animals[n.toInt()])
                "2" -> println(animals[n.toInt()])
                "3" -> println(animals[n.toInt()])
                "4" -> println(animals[n.toInt()])
                "5" -> println(animals[n.toInt()])
            }
            n = ""
        } else {
